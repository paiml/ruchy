...
fn test_registry_call_println() {
    ...
    // Test the exact call that's failing in the interpreter
...
fn test_string_processing() {
    ...
    // Test the exact string processing logic from interpreter
...
fn test_all_registered_functions() {
    ...
    // Test all the functions that should be registered
    let functions = vec![
        "println",
        "print",
        "dbg",
