...
unified_test!(test_basic_compilation, {
    // Test that basic Ruchy code compiles across platforms
...
unified_test!(test_transpilation_deterministic, {
    // Test that transpilation produces consistent results
...
unified_test!(test_memory_safety, {
    // Test that our code doesn't have obvious memory issues
...
mod wasm_specific_tests {
    ...
    fn test_wasm_console_access() {
        // Test that we can access console functions
