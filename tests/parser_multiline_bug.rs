...
fn test_incomplete_multiline_if_expression() {
    // Test the exact failing case: incomplete if expression should fail gracefully
...
fn test_complete_multiline_if_expression() {
    // Test that complete multiline if expressions work
...
fn test_block_parsing_with_newlines() {
    // Test that block parsing handles newlines correctly
...
fn test_incomplete_block_expression() {
    // Test incomplete block should fail gracefully
...
fn test_multiline_let_with_arithmetic() {
    // Test multiline let statement with arithmetic that spans lines
