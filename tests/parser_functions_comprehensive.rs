...
fn test_function_simple_definition() {
    ruchy_cmd()
        .arg("-e")
        .arg("fun add(x: i32, y: i32) -> i32 { x + y }; println(add(5, 3))")
        .assert()
        .success()
...
fn test_function_no_params() {
    ruchy_cmd()
        .arg("-e")
        .arg(r#"fun hello() { println("Hello") }; hello()"#)
        .assert()
        .success()
...
fn test_function_no_return_type() {
    ruchy_cmd()
        .arg("-e")
        .arg(r#"fun greet(name) { println(name) }; greet("World")"#)
        .assert()
        .success()
...
fn test_function_anonymous() {
    ruchy_cmd()
        .arg("-e")
        .arg("let f = fun (x: i32) -> i32 { x * 2 }; println(f(21))")
        .assert()
        .success()
...
fn test_function_with_type_params() {
    ruchy_cmd()
        .arg("-e")
        .arg("fun identity<T>(value: T) -> T { value }; println(identity(42))")
        .assert()
        .success()
        .stdout(predicate::str::contains("42"));
}
...
fn test_lambda_pipe_syntax_multiple_params() {
    ruchy_cmd()
        .arg("-e")
        .arg("let f = |x, y| x + y; println(f(20, 22))")
        .assert()
        .success()
        .stdout(predicate::str::contains("42"));
}
...
fn test_lambda_backslash_syntax() {
    ...
    ruchy_cmd()
        .arg("-e")
        .arg(r"let f = \x -> x * 2; println(f(21))")
        .assert()
        .success()
        .stdout(predicate::str::contains("42"));
}
...
fn test_lambda_backslash_multiple_params() {
    ruchy_cmd()
        .arg("-e")
        .arg(r"let f = \x, y -> x + y; println(f(20, 22))")
        .assert()
        .success()
        .stdout(predicate::str::contains("42"));
}
...
fn test_lambda_with_type_annotations() {
    ruchy_cmd()
        .arg("-e")
        .arg("let f = |x: i32, y: i32| x + y; println(f(20, 22))")
        .assert()
        .success()
        .stdout(predicate::str::contains("42"));
}
...
fn test_function_call_no_args() {
    ruchy_cmd()
        .arg("-e")
        .arg(r#"fun greet() { println("Hello") }; greet()"#)
        .assert()
        .success()
        .stdout(predicate::str::contains("Hello"));
}
...
fn test_function_call_multiple_args() {
    ruchy_cmd()
        .arg("-e")
        .arg("fun sum(a, b, c) { a + b + c }; println(sum(10, 20, 12))")
        .assert()
        .success()
        .stdout(predicate::str::contains("42"));
}
...
fn test_method_call_no_args() {
    ruchy_cmd()
        .arg("-e")
        .arg(r#"let s = "hello"; println(len(s))"#)
        .assert()
        .success()
...
fn test_method_call_with_args() {
    ...
    ruchy_cmd()
        .arg("-e")
        .arg(r"fun sum(a, b) { a + b }; println(sum(20, 22))")
        .assert()
        .success()
        .stdout(predicate::str::contains("42"));
}
...
fn edge_case_deeply_nested_calls() {
    ruchy_cmd()
        .arg("-e")
        .arg("fun f(x) { x }; println(f(f(f(f(42)))))")
        .assert()
        .success()
        .stdout(predicate::str::contains("42"));
}
...
fn error_case_missing_function_name() {
    ...
    ruchy_cmd()
        ...
        .arg("fun () { 42 }")
        .assert()
        .success(); // Anonymous functions are allowed
}
...
fn error_case_missing_right_paren() {
    ruchy_cmd()
        ...
        .arg("fun test(x { x }")
        .assert()
        .failure(); // Missing ) after parameters
}
...
fn error_case_missing_lambda_pipe() {
    ruchy_cmd()
        ...
        .arg("let f = |x x + 1")
        .assert()
        .failure(); // Missing | after lambda params
}
...
fn error_case_method_call_no_receiver() {
    ruchy_cmd().arg("-e").arg(".method()").assert().failure(); // Dot without receiver
}
