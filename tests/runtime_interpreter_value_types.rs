...
fn test_value_int_arithmetic() {
    ruchy_cmd().arg("-e").arg("println(42 + 8 - 10 * 2)")
...
fn test_value_int_zero() {
    ruchy_cmd().arg("-e").arg("let x = 0; println(x * 100)")
...
fn test_value_int_max_value() {
    ...
    ruchy_cmd().arg("-e").arg("let x = 2147483647; println(x)")
        .assert().success().stdout(predicate::str::contains("2147483647"));
}

#[test]
fn test_value_int_comparison() {
    ruchy_cmd().arg("-e").arg("println(10 > 5, 3 < 2, 7 == 7)")
        .assert().success()
...
fn test_value_float_arithmetic() {
    ruchy_cmd().arg("-e").arg("println(3.14 + 2.86)")
        .assert().success().stdout(predicate::str::contains("6"));
}

#[test]
fn test_value_float_precision() {
    ruchy_cmd().arg("-e").arg("let x = 0.1 + 0.2; println(x)")
        .assert().success(); // May have floating point imprecision
}

#[test]
fn test_value_float_negative() {
    ruchy_cmd().arg("-e").arg("let x = -3.14; println(x)")
        .assert().success().stdout(predicate::str::contains("-3.14"));
}

#[test]
fn test_value_float_zero() {
    ruchy_cmd().arg("-e").arg("let x = 0.0; println(x)")
        .assert().success().stdout(predicate::str::contains("0"));
}

#[test]
fn test_value_float_division() {
    ruchy_cmd().arg("-e").arg("println(10.0 / 4.0)")
        .assert().success().stdout(predicate::str::contains("2.5"));
}
...
fn test_value_string_empty() {
    ruchy_cmd().arg("-e").arg("let s = \"\"; println(len(s))")
        .assert().success().stdout(predicate::str::contains("0"));
}
...
fn test_value_string_multiline() {
    ruchy_cmd().arg("-e").arg(r#"let s = "line1\nline2"; println(s)"#)
        .assert().success();
}

#[test]
fn test_value_string_unicode() {
    ruchy_cmd().arg("-e").arg(r#"let s = "✓ ✗ 🚀"; println(len(s))"#)
        .assert().success(); // Unicode length
}

#[test]
fn test_value_string_escape_sequences() {
    ruchy_cmd().arg("-e").arg(r#"println("tab:\t\nnewline")"#)
        .assert().success();
}

#[test]
fn test_value_string_multiplication() {
    ruchy_cmd().arg("-e").arg(r#"println("x" * 10)"#)
        .assert().success().stdout(predicate::str::contains("xxxxxxxxxx"));
}
...
fn test_value_bool_true() {
    ruchy_cmd().arg("-e").arg("let b = true; println(b)")
        .assert().success().stdout(predicate::str::contains("true"));
}

#[test]
fn test_value_bool_false() {
    ruchy_cmd().arg("-e").arg("let b = false; println(b)")
...
fn test_value_bool_from_comparison() {
    ruchy_cmd().arg("-e").arg("let b = 10 > 5; println(b)")
        .assert().success().stdout(predicate::str::contains("true"));
}
...
fn test_value_array_indexing() {
    ruchy_cmd().arg("-e").arg("let arr = [10, 20, 30]; println(arr[0], arr[1], arr[2])")
        .assert().success()
...
fn test_value_function_closure() {
    ruchy_cmd().arg("-e").arg("let f = |x| x * 2; println(f(21))")
        .assert().success().stdout(predicate::str::contains("42"));
}
...
fn test_value_nil_assignment() {
    ruchy_cmd().arg("-e").arg("let x = nil; println(\"OK\")")
        .assert().success().stdout(predicate::str::contains("OK"));
}

#[test]
fn test_value_nil_comparison() {
    ruchy_cmd().arg("-e").arg("let x = nil; let y = nil; println(x == y)")
        .assert().success(); // May print true or may not support nil comparison
}
...
fn test_value_conversion_float_to_int() {
    ruchy_cmd().arg("-e").arg("let x = 3.7; let y = int(x); println(y)")
        .assert().success().stdout(predicate::str::contains("3"));
}

#[test]
fn test_value_conversion_int_to_string() {
    ruchy_cmd().arg("-e").arg("let x = 42; let s = str(x); println(s)")
        .assert().success().stdout(predicate::str::contains("42"));
}

#[test]
fn test_value_conversion_string_to_int() {
    ruchy_cmd().arg("-e").arg(r#"let s = "123"; let x = int(s); println(x)"#)
...
fn test_value_conversion_int_to_bool() {
    ruchy_cmd().arg("-e").arg("println(bool(1), bool(0))")
        .assert().success()
        .stdout(predicate::str::contains("true"))
        .stdout(predicate::str::contains("false"));
}
...
fn edge_case_empty_string_operations() {
    ruchy_cmd().arg("-e").arg(r#"let s = ""; println(len(s) == 0)"#)
        .assert().success().stdout(predicate::str::contains("true"));
}
...
fn edge_case_deeply_nested_arrays() {
    ruchy_cmd().arg("-e").arg("let arr = [[[[[42]]]]]; println(arr[0][0][0][0][0])")
        .assert().success().stdout(predicate::str::contains("42"));
}
