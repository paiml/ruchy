...
mod debug_tests {
    use ruchy::runtime::repl::debug::{
        DebugManager, DebugConfig, DebugEvent, Breakpoint, BreakpointCondition,
        Profiler, ProfileData, MemoryTracker, TraceContext
    };
    ...
    fn test_format_duration() {
        ...
        assert_eq!(manager.format_duration(Duration::from_micros(1500)), "1.5ms");
