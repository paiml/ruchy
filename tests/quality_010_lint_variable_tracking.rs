...
";
    ...
    assert!(
        stdout.contains("unused variable: unused"),
        "Should detect unused variable"
    );
    assert!(
        !stdout.contains("unused variable: used"),
        "Should not flag used variable"
    );
}
...
";
    ...
    let stdout = String::from_utf8_lossy(&output.stdout);
    assert!(
        stdout.contains("undefined variable: undefined_var"),
...
";
    ...
    let stdout = String::from_utf8_lossy(&output.stdout);
    assert!(
        stdout.contains("undefined variable: inner"),
        "Should detect out-of-scope variable"
    );
}
...
";
    ...
    let stdout = String::from_utf8_lossy(&output.stdout);
    assert!(
        stdout.contains("variable shadowing: x"),
...
";
    ...
    let stdout = String::from_utf8_lossy(&output.stdout);
    assert!(
        stdout.contains("unused parameter: unused"),
...
";
    ...
    let stdout = String::from_utf8_lossy(&output.stdout);
    assert!(
        stdout.contains("unused loop variable: i"),
        "Should detect unused loop variable"
    );
}
...
";
    ...
    assert!(
        stdout.contains("unused match binding: value"),
        "Should detect unused match binding"
    );
}
