...
fn test_list_with_defaults_basic() {
    // Test basic default destructuring
    let code = r#"
let [a = 10, b = 20] = [1];
println(a);
println(b);
...
fn test_list_with_defaults_empty_array() {
    // Test with empty array - all defaults should be used
    let code = r#"
let [a = 10, b = 20] = [];
println(a);
println(b);
...
fn test_list_with_defaults_mixed() {
    // Test mixed patterns - some with defaults, some without
    let code = r#"
let arr = [1, 2, 3];
let [x, y = 99, z = 88] = arr;
println(x);
...
fn test_mixed_destructuring() {
    // Test mixed tuple and object destructuring
    let code = r#"
...
fn test_rest_pattern_with_defaults() {
    // Test rest patterns combined with defaults
    let code = r#"
...
fn test_complex_default_expressions() {
    // Test that complex default expressions work
    let code = r#"
