...
fn test_matrix_native_04_02_sliding_window_extraction() {
    ...
    repl.send_line("series[1]").expect("Failed to send command");
...
fn test_matrix_native_04_05_rolling_max() {
    ...
    // Max is at index 1
    repl.send_line("window[1]").expect("Failed to send command");
...
fn test_matrix_native_04_07_trend_direction() {
    ...
    repl.exp_string("20")
        .expect("Uptrend magnitude should be 20");
}
...
fn test_matrix_native_04_08_volatility_range() {
    ...
    repl.exp_string("25")
        .expect("Volatility range should be 25");
}
...
fn test_matrix_native_04_11_exponential_weighting() {
    ...
    repl.exp_string("94")
        .expect("Exponential weighted value should be 94");
}
...
fn test_matrix_native_04_12_anomaly_detection_threshold() {
    ...
    repl.exp_string("50")
        .expect("Deviation should be 50 (anomaly detected)");
}
...
fn test_matrix_native_04_13_seasonality_check() {
    ...
    repl.exp_string("5")
        .expect("Seasonal difference should be 5");
}
...
fn test_matrix_native_04_14_lag_calculation() {
    ...
    repl.exp_string("10")
        .expect("Difference from lag should be 10");
}
