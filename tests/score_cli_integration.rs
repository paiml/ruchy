...
fn test_score_output_to_file() {
    ...
    // Check output file was created and contains score
...
",
    ...
    assert!(
        score >= 0.95,
        "Perfect code should score >= 0.95, got {score}"
    );
}
...
",
    ...
    assert!(
        score <= 0.20,
        "Terrible code should score <= 0.20, got {score}"
    );
}
