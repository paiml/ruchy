...
mod edge_case_protection {
    ...
    fn test_empty_input_never_crashes() {
        ...
        for input in empty_cases {
            ...
            assert!(output.status.success() || !output.stderr.is_empty(),
                    "EDGE CASE BROKEN: Empty input crashed - '{}'", input);
        }
    ...
    fn test_long_identifier_handling() {
        ...
        let has_meaningful_response = output.status.success() || 
    ...
    fn test_deep_nesting_protection() {
        ...
        assert!(stdout.contains("1") || !output.stderr.is_empty(),
                "EDGE CASE BROKEN: Deep nesting failed - {}", stdout);
    ...
    fn test_large_number_handling() {
        ...
        for num in large_numbers {
            ...
            let stdout = String::from_utf8_lossy(&output.stdout);
            assert!(stdout.contains(num) || !output.stderr.is_empty(),
                    "EDGE CASE BROKEN: Large number failed - {}", num);
        }
    ...
    fn test_special_character_handling() {
        ...
        for case in special_cases {
            ...
            assert!(output.status.success() || !output.stderr.is_empty(),
                    "EDGE CASE BROKEN: Special characters failed - {}", case);
        }
    ...
    fn test_malformed_syntax_protection() {
        ...
        for case in malformed_cases {
            ...
            assert!(has_error,
                    "EDGE CASE BROKEN: Malformed syntax should error - {}", case);
        }
    ...
    fn test_recursion_depth_protection() {
        ...
        let stdout = String::from_utf8_lossy(&output.stdout);
        assert!(stdout.contains("0") || !output.stderr.is_empty(),
                "EDGE CASE BROKEN: Recursion protection failed - {}", stdout);
