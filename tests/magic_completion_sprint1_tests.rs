...
fn test_repl_multiline_input() {
    ...
    // Check multiline function definition
    let multiline = r#"
        fn test_func(x) {
            let result = x * 2;
            result + 1
...
fn test_repl_sandboxed_restrictions() {
    ...
    // Check that basic restrictions work by timeout
...
fn test_repl_pipeline_operator() {
    ...
    // Check pipeline operator if supported
...
fn test_repl_method_chaining() {
    ...
    // Check method chaining on strings
