...
"#;
    ...
    assert!(
        ...
        "Should report actual line counts, not 0/0. Found: {}",
        output_str
    );
}
...
"#;
    ...
    assert!(
        ...
        "Should report actual function counts, not 0/0. Found: {}",
        output_str
    );
}
...
"#;
    ...
    assert!(
        ...
        "Should report actual line numbers, not 0/0. Found: {}",
        output_str
    );
}
