...
fn identifier_strategy() -> impl Strategy<Value = String> {
    "[a-zA-Z][a-zA-Z0-9_]{0,10}"
        ...
        .prop_filter("must not be a keyword", |s| {
            !matches!(s.as_str(), 
                "if" | "else" | "match" | "case" | "fn" | "let" | "mut" | "const" | 
                "for" | "while" | "break" | "continue" | "return" | "import" | "export" |
                "module" | "struct" | "enum" | "impl" | "trait" | "pub" | "private" | 
                "as" | "in" | "where" | "async" | "await" | "yield" | "move" | "ref" |
                "static" | "self" | "Self" | "super" | "crate" | "extern" | "unsafe" |
                "use" | "mod" | "type" | "typeof" | "sizeof" | "alignof" | "offsetof" |
                "true" | "false" | "null" | "nil" | "undefined" | "NaN" | "Infinity" |
                "and" | "or" | "not" | "is" | "from" | "with" | "try" | "catch" |
                "finally" | "throw" | "throws" | "default" | "do" | "switch" | "df")
        })
}

// Strategy for generating module paths
fn module_path_strategy() -> impl Strategy<Value = String> {
    prop::collection::vec(identifier_strategy(), 1..5)
