...
// Check specific interpreter functions for better coverage
...
fn test_eval_function_call() {
    ...
    let expr = make_expr(ExprKind::Call {
        func: Box::new(make_expr(ExprKind::Identifier("println".to_string()))),
...
fn test_eval_for_loop() {
    ...
    let expr = make_expr(ExprKind::For {
        ...
        iter: Box::new(make_expr(ExprKind::Range {
...
fn test_eval_match() {
    ...
    let expr = make_expr(ExprKind::Match {
        ...
        arms: vec![
            MatchArm {
                pattern: Pattern::Literal(Literal::Integer(42)),
                guard: None,
