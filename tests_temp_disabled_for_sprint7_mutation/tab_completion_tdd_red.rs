...
mod tab_completion_red_tests {
    ...
    fn test_builtin_completions() {
        ...
        assert!(
            completion_text.contains("println"),
            "Missing println in completions: {}",
            completion_text
        );
    }
    ...
    fn test_variable_completions() {
        ...
        bindings.insert("test_var".to_string(), ruchy::runtime::Value::Integer(42));
        bindings.insert(
            "test_var2".to_string(),
            ruchy::runtime::Value::String(std::rc::Rc::from("test")),
        );
        ...
        assert!(
            completion_text.contains("test_var"),
            "Missing test_var in completions: {}",
            completion_text
        );
        assert!(
            completion_text.contains("test_var2"),
            "Missing test_var2 in completions: {}",
            completion_text
        );
    }
