...
fn test_complete_programs() {
    ...
    for program in programs {
        ...
        assert!(
            ...
            "Program should contain main function: {program}"
        );
        assert!(
            code.contains('{'),
            "Program should have block structure: {program}"
        );
        assert!(
            code.contains('}'),
            "Program should have closing braces: {program}"
        );
    }
}
...
fn test_expression_programs() {
    ...
    for expr in expressions {
        ...
        assert!(
            code.contains("fn main"),
            "Expression '{expr}' should be wrapped in main"
        );
    }
}
...
fn test_all_statements() {
    ...
    for stmt in statements {
        ...
        let ast = parser
            .parse()
            .unwrap_or_else(|_| panic!("Failed to parse: {stmt}"));
...
fn test_all_expressions() {
    ...
    for expr in expressions {
        ...
        assert!(
            !code.is_empty(),
            "Expression '{expr}' should produce output"
        );
    }
}
...
fn test_function_definitions() {
    ...
    for func in functions {
        ...
        let ast = parser
            .parse()
            .unwrap_or_else(|_| panic!("Failed to parse: {func}"));
        ...
        assert!(
            code.contains("fn"),
            "Function '{func}' should contain 'fn' keyword"
        );
    }
}
...
fn test_control_flow() {
    ...
    for flow in control_flows {
        ...
        let ast = parser
            .parse()
            .unwrap_or_else(|_| panic!("Failed to parse: {flow}"));
        ...
        assert!(
            !code.is_empty(),
            "Control flow '{flow}' should produce output"
        );
    }
}
...
fn test_type_features() {
    ...
    for feature in type_features {
        ...
        let ast = parser
            .parse()
            .unwrap_or_else(|_| panic!("Failed to parse: {feature}"));
        ...
        assert!(
            !code.is_empty(),
            "Type feature '{feature}' should produce output"
        );
    }
}
...
fn test_error_handling() {
    ...
    for handling in error_handling {
        ...
        let ast = parser
            .parse()
            .unwrap_or_else(|_| panic!("Failed to parse: {handling}"));
        ...
        assert!(
            !code.is_empty(),
            "Error handling '{handling}' should produce output"
        );
    }
}
...
fn test_operators() {
    ...
    for op in operators {
        ...
        let ast = parser
            .parse()
            .unwrap_or_else(|_| panic!("Failed to parse: {op}"));
...
fn test_string_features() {
    ...
    for feature in string_features {
        ...
        assert!(
            !code.is_empty(),
            "String feature '{feature}' should produce output"
        );
    }
}
