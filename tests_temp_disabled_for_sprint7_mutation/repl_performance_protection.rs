...
mod performance_protection {
    ...
    fn test_basic_operation_performance_never_degrades() {
        ...
        for (input, max_duration) in performance_tests {
            ...
            assert!(
                ...
                "PERFORMANCE REGRESSION: Operation failed - {}",
                input
            );
            assert!(
            ...
            println!(
                "✅ PERFORMANCE: {} completed in {:?} (limit: {:?})",
    ...
    fn test_complex_operation_performance_bounds() {
        ...
        for (script, max_duration) in complex_tests {
            ...
            println!(
                "✅ PERFORMANCE: Complex operation completed in {:?} (limit: {:?})",
                duration, max_duration
            );
        }
    }
    ...
    fn test_repl_startup_performance() {
        ...
        println!(
            "✅ PERFORMANCE: REPL startup in {:?} (limit: {:?})",
            startup_duration, startup_limit
        );
    }
    ...
    fn test_memory_usage_bounds() {
        ...
        for script in memory_tests {
            ...
            assert!(
                ...
                "PERFORMANCE REGRESSION: Memory test took too long: {:?}",
                duration
            );
    ...
    fn test_tab_completion_performance() {
        ...
        for i in 0..1000 {
            bindings.insert(
                format!("test_var_{}", i),
                ruchy::runtime::repl::Value::Int(i),
            );
        }
        ...
        for (input, pos) in completion_tests {
            ...
            println!(
                "✅ PERFORMANCE: Tab completion '{}' in {:?} ({} results)",
                input,
                duration,
                completions.len()
            );
    ...
    fn test_parsing_performance_patterns() {
        ...
        for (code, max_duration) in parsing_tests {
            ...
            println!(
                "✅ PERFORMANCE: Parsing completed in {:?} (limit: {:?})",
                duration, max_duration
            );
        }
    }
    ...
    fn test_large_data_performance() {
        ...
        for (code, max_duration) in large_data_tests {
            ...
            println!(
                "✅ PERFORMANCE: Large data operation in {:?} (limit: {:?})",
                duration, max_duration
            );
        }
    }
    ...
    fn test_concurrent_performance() {
        ...
        assert!(
            ...
            total_duration,
            concurrent_duration_limit
        );

        println!(
            "✅ PERFORMANCE: Concurrent execution in {:?} (limit: {:?})",
            total_duration, concurrent_duration_limit
        );
    }
}
