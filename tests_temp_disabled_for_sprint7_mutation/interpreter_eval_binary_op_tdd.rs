...
mod eval_binary_op_tdd {
    ...
    fn test_arithmetic_add() {
        ...
        // Integer + Integer
        let result =
            interpreter.eval_binary_op(AstBinaryOp::Add, &Value::Integer(5), &Value::Integer(3));
        assert_eq!(result.unwrap(), Value::Integer(8));

        // Float + Float
        let result =
            interpreter.eval_binary_op(AstBinaryOp::Add, &Value::Float(2.5), &Value::Float(1.5));
    ...
    fn test_arithmetic_power() {
        ...
        let result =
            interpreter.eval_binary_op(AstBinaryOp::Power, &Value::Integer(2), &Value::Integer(3));
        assert_eq!(result.unwrap(), Value::Integer(8));

        let result =
            interpreter.eval_binary_op(AstBinaryOp::Power, &Value::Float(2.0), &Value::Float(3.0));
        assert_eq!(result.unwrap(), Value::Float(8.0));
    }
    ...
    fn test_comparison_equal() {
        ...
        let result =
            interpreter.eval_binary_op(AstBinaryOp::Equal, &Value::Integer(5), &Value::Integer(5));
        assert_eq!(result.unwrap(), Value::Bool(true));

        let result =
            interpreter.eval_binary_op(AstBinaryOp::Equal, &Value::Integer(5), &Value::Integer(3));
    ...
    fn test_comparison_less_than() {
        ...
        let result =
            interpreter.eval_binary_op(AstBinaryOp::Less, &Value::Integer(3), &Value::Integer(5));
        assert_eq!(result.unwrap(), Value::Bool(true));

        let result =
            interpreter.eval_binary_op(AstBinaryOp::Less, &Value::Integer(5), &Value::Integer(3));
        assert_eq!(result.unwrap(), Value::Bool(false));

        let result =
            interpreter.eval_binary_op(AstBinaryOp::Less, &Value::Integer(5), &Value::Integer(5));
        assert_eq!(result.unwrap(), Value::Bool(false));
    }
    ...
    fn test_logical_and() {
        ...
        let result =
            interpreter.eval_binary_op(AstBinaryOp::And, &Value::Bool(true), &Value::Integer(42));
        assert_eq!(result.unwrap(), Value::Integer(42));

        // False && True = False (returns left operand)
        let result =
            interpreter.eval_binary_op(AstBinaryOp::And, &Value::Bool(false), &Value::Integer(42));
        assert_eq!(result.unwrap(), Value::Bool(false));
    ...
    fn test_logical_or() {
        ...
        let result =
            interpreter.eval_binary_op(AstBinaryOp::Or, &Value::Integer(42), &Value::Bool(false));
        assert_eq!(result.unwrap(), Value::Integer(42));

        // False || True = True (returns right operand)
        let result =
            interpreter.eval_binary_op(AstBinaryOp::Or, &Value::Bool(false), &Value::Integer(42));
        assert_eq!(result.unwrap(), Value::Integer(42));
    ...
    fn test_unsupported_operations() {
        ...
        let result =
            interpreter.eval_binary_op(AstBinaryOp::Add, &Value::Integer(5), &Value::Bool(true));
        assert!(result.is_err());
    }
