...
Captured with `--exclude broken` (intentional test-fixture dirs).

| Repo | Files | LoC | Functions | Bronze | Silver+ | pub Bronze | parse_errors |
|------|------:|----:|----------:|-------:|--------:|-----------:|-------------:|
| ruchy-book | 130 | 3,022 | 180 | 180 | 0 | 0 | 0 |
...
| ruchyruchy | 536 | 171,714 | 3,875 | 3,875 | 0 | 0 | 113 |
| **TOTAL** | **997** | **244,801** | **6,371** | **6,371** | **0** | **80** | **156** |

## §14.5 Takeaway

**100% of the 6,371 Ruchy functions in the paiml corpus are Bronze tier.**
...
- ruchyruchy: 113 (largest corpus)
- rosetta-ruchy: 29
- ruchy-cookbook: 10
- ruchy-repl-demos: 4
- ruchy-book: 0 (fixed by `--exclude broken`; were test fixtures)
- Others: 0
