...
fn test_dataframe_select() {
    ...
    let result = eval_dataframe_select(&columns, &args).expect("operation should succeed in test");
...
fn test_dataframe_slice() {
    ...
    let result = eval_dataframe_slice(&columns, &args).expect("operation should succeed in test");
...
fn test_dataframe_groupby_basic() {
    ...
    let result = eval_dataframe_groupby(&columns, &args).expect("operation should succeed in test");
...
fn test_eval_dataframe_get_basic() {
    ...
    let args = vec![Value::from_string("age".to_string()), Value::Integer(1)];
...
fn test_eval_dataframe_get_first_row() {
    ...
    let args = vec![Value::from_string("x".to_string()), Value::Integer(0)];
...
fn test_eval_dataframe_get_negative_row_index() {
    ...
    let args = vec![Value::from_string("x".to_string()), Value::Integer(-1)];
    let result = eval_dataframe_get(&columns, &args);
    assert!(result.is_err());
...
fn test_eval_dataframe_get_column_not_found() {
    ...
    let args = vec![Value::from_string("missing".to_string()), Value::Integer(0)];
    let result = eval_dataframe_get(&columns, &args);
    assert!(result.is_err());
...
fn test_eval_dataframe_get_row_out_of_bounds() {
    ...
    let args = vec![Value::from_string("x".to_string()), Value::Integer(5)];
    let result = eval_dataframe_get(&columns, &args);
    assert!(result.is_err());
...
fn test_eval_dataframe_get_string_value() {
    ...
    let args = vec![Value::from_string("city".to_string()), Value::Integer(1)];
