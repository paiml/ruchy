...
fn test_process_actor_message_sync_mut_type_validation_pass() {
    ...
    let handler = make_handler_with_types("SetValue", vec!["value".to_string()], vec!["i32"], body);
...
fn test_actor_instance_send_simple_value() {
    ...
    let result =
        interp.eval_actor_instance_method(&instance, "TestActor", "send", &[Value::Integer(42)]);
...
fn test_process_actor_message_sync_mut_any_type() {
    ...
    let handler = make_handler_with_types("Accept", vec!["value".to_string()], vec!["Any"], body);
...
fn test_process_actor_message_sync_mut_float_type() {
    ...
    let body = make_expr(ExprKind::Literal(Literal::Integer(1, None)));
    let handler = make_handler_with_types("SetFloat", vec!["value".to_string()], vec!["f64"], body);
...
fn test_process_actor_message_sync_mut_bool_type() {
    ...
    let body = make_expr(ExprKind::Literal(Literal::Integer(1, None)));
    let handler = make_handler_with_types("SetBool", vec!["value".to_string()], vec!["bool"], body);
...
fn test_process_actor_message_sync_mut_str_type_alias() {
    ...
    let body = make_expr(ExprKind::Literal(Literal::Integer(1, None)));
    let handler = make_handler_with_types("SetStr", vec!["value".to_string()], vec!["str"], body);
...
fn test_actor_send_simple_value_sync() {
    ...
    let result =
        interp.eval_actor_instance_method(&instance, "TestActor", "send", &[Value::Integer(100)]);
...
fn test_actor_ask_with_non_object_msg() {
    ...
    let result =
        interp.eval_actor_instance_method(&instance, "TestActor", "ask", &[Value::Integer(42)]);
...
fn test_actor_ask_with_handler_closure_cov() {
    ...
    let handler_closure = make_closure(vec![("name".to_string(), None)], handler_body);
