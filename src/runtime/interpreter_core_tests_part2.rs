...
fn test_call_function_unknown_builtin_error() {
    let mut interp = make_interpreter();
    let func = Value::from_string("__builtin_nonexistent_function__".to_string());
    let result = interp.call_function(func, &[]);
    assert!(result.is_err());
    assert!(result
        .unwrap_err()
...
fn test_call_function_closure_basic() {
    ...
    let func = Value::Closure {
        params: vec![("x".to_string(), None)],
        body: std::sync::Arc::new(make_expr(ExprKind::Identifier("x".to_string()))),
        env: Rc::new(RefCell::new(std::collections::HashMap::new())),
    };
    let result = interp.call_function(func, &[Value::Integer(42)]).unwrap();
    assert_eq!(result, Value::Integer(42));
}
...
fn test_call_function_closure_wrong_arg_count() {
    ...
    let func = Value::Closure {
        params: vec![("x".to_string(), None), ("y".to_string(), None)],
        body: std::sync::Arc::new(make_expr(ExprKind::Literal(Literal::Integer(1, None)))),
        env: Rc::new(RefCell::new(std::collections::HashMap::new())),
    };
...
fn test_call_function_closure_with_default_param() {
    ...
    let mut interp = make_interpreter();
    let default_expr =
        std::sync::Arc::new(make_expr(ExprKind::Literal(Literal::Integer(99, None))));
    let func = Value::Closure {
        params: vec![
            ("x".to_string(), None),
            ("y".to_string(), Some(default_expr)),
        ],
        body: std::sync::Arc::new(make_expr(ExprKind::Identifier("y".to_string()))),
        env: Rc::new(RefCell::new(std::collections::HashMap::new())),
    };
    // Call with only required arg, y should get default
    let result = interp.call_function(func, &[Value::Integer(1)]).unwrap();
    assert_eq!(result, Value::Integer(99));
}
...
fn test_call_function_class_static_method_marker() {
    ...
    let func = Value::from_string("__class_static_method__:Foo:bar".to_string());
    let result = interp.call_function(func, &[]);
...
fn test_call_function_struct_constructor_marker() {
    ...
    let func = Value::from_string("__struct_constructor__:Point".to_string());
    let result = interp.call_function(func, &[]);
...
fn test_call_function_actor_constructor_marker() {
    ...
    let func = Value::from_string("__actor_constructor__:Counter".to_string());
    let result = interp.call_function(func, &[]);
...
fn test_call_function_class_constructor_marker() {
    ...
    let func = Value::from_string("__class_constructor__:MyClass".to_string());
    let result = interp.call_function(func, &[]);
...
fn test_call_function_invalid_static_method_marker() {
    ...
    let func = Value::from_string("__class_static_method__:invalid".to_string());
    let result = interp.call_function(func, &[]);
    assert!(result.is_err());
}
...
fn test_call_function_object_struct_type() {
    ...
    interp.set_variable(
        "Point",
        Value::Object(std::sync::Arc::new(struct_def.clone())),
    );
...
fn test_call_function_object_actor_type() {
    ...
    interp.set_variable(
        "Counter",
        Value::Object(std::sync::Arc::new(actor_def.clone())),
    );
...
fn test_call_function_object_class_type() {
    ...
    interp.set_variable(
        "Person",
        Value::Object(std::sync::Arc::new(class_def.clone())),
    );
