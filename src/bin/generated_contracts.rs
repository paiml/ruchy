...
macro_rules! contract_pre_format_report {
    ...
    ($input:expr) => {{
        ...
        debug_assert!(
            entries.len() > 0,
            "Contract format_report: precondition violated — entries.len() > 0"
        );
    }};
}
...
macro_rules! contract_pre_serialize_roundtrip {
    ...
    ($input:expr) => {{
        ...
        debug_assert!(
            !data.is_empty(),
            "Contract serialize_roundtrip: precondition violated — !data.is_empty()"
        );
        debug_assert!(
            data.len() > 0,
            "Contract serialize_roundtrip: precondition violated — data.len() > 0"
        );
    }};
}
...
macro_rules! contract_pre_constraint_matrix_exhaustiveness {
    ...
    ($input:expr) => {{
        ...
        debug_assert!(constraints.len() > 0,
            "Contract constraint_matrix_exhaustiveness: precondition violated — constraints.len() > 0");
    }};
}
...
macro_rules! contract_pre_name_bijection {
    ...
    ($input:expr) => {{
        ...
        debug_assert!(
            names.len() > 0,
            "Contract name_bijection: precondition violated — names.len() > 0"
        );
    }};
}
...
macro_rules! contract_pre_format_parity {
    ...
    ($input:expr) => {{
        ...
        debug_assert!(
            !data.is_empty(),
            "Contract format_parity: precondition violated — !data.is_empty()"
        );
        debug_assert!(
            data.len() > 0,
            "Contract format_parity: precondition violated — data.len() > 0"
        );
    }};
}
...
// Total: 521 preconditions, 11 postconditions from 165 contracts
