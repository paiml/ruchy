...
//!
//! This module coordinates the transpilation of statements and control flow,
//! delegating to specialized submodules for different statement types.

#![allow(clippy::missing_errors_doc)]
#![allow(clippy::wildcard_imports)]
#![allow(clippy::collapsible_else_if)]

pub mod statements_modules;
